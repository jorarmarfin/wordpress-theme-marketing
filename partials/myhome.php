...
<section id="home" class="section section-with-shape-divider custom-bg-color-1 border-0 pt-0 m-0">
	...
	<div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0">
		<div class="custom-section-svg-background appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="2300" style="background-image: url(wp-content/themes/marketingtheme/assets/img/demos/startup-agency/backgrounds/morphing-bg-1.jpg); background-size: cover; background-position: center;"></div>
		...
		<div class="container mt-5 pt-5">
			<div class="row align-items-center pt-5 mt-5 mt-lg-0 pt-lg-0">
				<div class="col-lg-6">
					<h1 class="font-weight-bold text-12 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">We Are Digital Experts</h1>
					<h2 class="font-weight-medium text-9 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">Based in Los Angeles / CA</h2>
					<p class="custom-font-secondary custom-font-size-1 mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Lorem ipsum dolor sit amet, consectetur adipis.</p>
