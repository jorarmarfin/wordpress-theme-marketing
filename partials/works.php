                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-10 text-center">
                            <span class="d-block text-color-grey positive-ls-2 font-weight-normal custom-font-size-2 text-color-light opacity-6 mb-1">OUR WORK</span>
                            ...
                            <div class="owl-carousel custom-carousel-backward-shape custom-dots-style-1 custom-dots-style-1-light" data-plugin-options="{'responsive': {'0': {'items': 1, 'stagePadding': 100}, '479': {'items': 1, 'stagePadding': 100}, '768': {'items': 3, 'stagePadding': 100}, '992': {'items': 3, 'stagePadding': 100}, '1200': {'items': 4}}, 'autoplay': true, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'dots': true, 'nav': false, 'center': true, 'loop': true, 'margin': 25}">
                                    ...
                                    <a href="#">
                                        <div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                                            <div class="thumb-info-wrapper rounded-0">
                                                <img src="wp-content/themes/marketingtheme/assets/img/demos/startup-agency/works/work-1.jpg" class="img-fluid rounded-0" alt="Work 1" />
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="my-5">
                                    <a href="#">
                                        <div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                                            <div class="thumb-info-wrapper rounded-0">
                                                <img src="wp-content/themes/marketingtheme/assets/img/demos/startup-agency/works/work-2.jpg" class="img-fluid rounded-0" alt="Work 2" />
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="my-5">
                                    <a href="#">
                                        <div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                                            <div class="thumb-info-wrapper rounded-0">
                                                <img src="wp-content/themes/marketingtheme/assets/img/demos/startup-agency/works/work-3.jpg" class="img-fluid rounded-0" alt="Work 3" />
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="my-5">
                                    <a href="#">
                                        <div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                                            <div class="thumb-info-wrapper rounded-0">
                                                <img src="wp-content/themes/marketingtheme/assets/img/demos/startup-agency/works/work-4.jpg" class="img-fluid rounded-0" alt="Work 4" />
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="my-5">
                                    <a href="#">
                                        <div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                                            <div class="thumb-info-wrapper rounded-0">
                                                <img src="wp-content/themes/marketingtheme/assets/img/demos/startup-agency/works/work-5.jpg" class="img-fluid rounded-0" alt="Work 5" />
                                            </div>
                                        </div>
                                    </a>
                                </div>
